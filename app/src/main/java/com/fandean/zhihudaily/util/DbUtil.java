...
import com.fandean.zhihudaily.db.ZhihuNewsCursorWrapper;
import com.fandean.zhihudaily.db.ZhihuNewsDbSchema;
...
import static com.fandean.zhihudaily.db.ZhihuNewsDbSchema.ZhihuNewses;
import static com.fandean.zhihudaily.db.ZhihuNewsDbSchema.ZhihuStories;
...
//        String str = new String(jsonBytes,Charset.forName("UTF-8"));
    ...
    public static ContentValues getContentValues(Collection collection){
        ContentValues values = new ContentValues();
        values.put(ZhihuNewsDbSchema.Favorites.Cols.ID,collection.getId());
        values.put(ZhihuNewsDbSchema.Favorites.Cols.TYPE,collection.getType());
    ...
    public static void deleteCollection(SQLiteDatabase db,Collection collection){
        String id = collection.getId();
        db.delete(ZhihuNewsDbSchema.Favorites.NAME,
                ZhihuNewsDbSchema.Favorites.Cols.ID + " = ?", new String[]{id});
    }
    ...
    public static boolean isCollection(SQLiteDatabase db, int id){
        CollectionCursorWrapper cursor = queryCollection(db,
                ZhihuNewsDbSchema.Favorites.Cols.ID + " = ?",
    ...
    public static class CollectionCursorWrapper extends CursorWrapper {
        ...
        public Collection getCollection(){
            ...
            collection.setId(getString(getColumnIndex(ZhihuNewsDbSchema.Favorites.Cols.ID)));
